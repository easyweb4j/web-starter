...
public interface HouseMapper {
  ...
  @Insert("insert into house (name, floor_number, state, state_ts) values(#{name}, #{floorNumber}, #{state}, #{stateTs})")
  ...
  @Insert("insert into house (name, floor_number, state, state_ts) values(#{name},, #{DEFAULT_FLOOR}, #{state}, #{stateTs})")
  @SelectKey(statement = "SELECT LAST_INSERT_ID()", keyProperty = "id", before = false, resultType = int.class)
